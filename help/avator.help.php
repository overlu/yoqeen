...
class Avator
{
	 ...
	 * 创建头像
	 */
	public function create($Char, $AvatarSize = 256)
    {
        $this->Char            = strtoupper(mb_substr($Char, 0, 1, "UTF-8"));
        $this->AvatarSize      = $AvatarSize;
        $this->Padding         = 30 * ($this->AvatarSize / 256);
        $this->LetterFont      = MEDIA.DS.'ttfs'.DS.'SourceCodePro-Light.ttf';
        $this->AsianFont       = MEDIA.DS.'ttfs'.DS.'SourceHanSansCN-Normal.ttf';
